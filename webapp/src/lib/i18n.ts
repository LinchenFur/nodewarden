...
messages.en.nav_organizations = 'Organizations';
messages.en.txt_create_organization = 'Create Organization';
messages.en.txt_create_organization_failed = 'Failed to create organization';
messages.en.txt_create_collection = 'Create Collection';
messages.en.txt_create_collection_failed = 'Failed to create collection';
messages.en.txt_organization_name = 'Organization name';
messages.en.txt_organization_name_placeholder = 'Team vault name';
messages.en.txt_organization_name_required = 'Organization name is required';
messages.en.txt_billing_email_optional = 'Billing email';
messages.en.txt_default_collection = 'Default collection';
messages.en.txt_default_collection_placeholder = 'Default';
messages.en.txt_default_collection_help = 'Leave blank to use the default collection name.';
messages.en.txt_your_organizations = 'Your organizations';
messages.en.txt_no_organizations_yet = 'No organizations yet. Create the first one here.';
messages.en.txt_select_an_organization = 'Select an organization';
messages.en.txt_select_an_organization_help = 'Choose an organization on the left to manage its collections and members.';
messages.en.txt_organization_page_intro = 'Create a shared vault, review collections, and update member access in one place.';
messages.en.txt_organization_overview_help = 'Shared vault details and permission overview.';
messages.en.txt_organization_created = 'Organization created';
messages.en.txt_collections = 'Collections';
messages.en.txt_members = 'Members';
messages.en.txt_confirmed = 'Confirmed';
messages.en.txt_collection_name_required = 'Collection name is required';
messages.en.txt_collection_name_placeholder = 'Collection name';
messages.en.txt_organization_collection_created = 'Collection created';
messages.en.txt_organization_collections_help = 'Collections decide which members can see and edit organization vault items.';
messages.en.txt_organization_collections_read_only = 'You can view collections here, but only organization managers with full access can create new ones.';
messages.en.txt_no_collections_yet = 'No collections yet. Create one to start grouping shared items.';
messages.en.txt_organization_members_help = 'Update role level, collection visibility, and edit rights for each member.';
messages.en.txt_organization_member_invite_note = 'Member invite and acceptance flows are not wired into the UI yet. This page manages existing members and their collection access.';
messages.en.txt_organization_members_read_only = 'Your current organization role is read-only here.';
messages.en.txt_organization_owner_required_for_admin_roles = 'Only an owner can grant or remove owner/admin roles.';
messages.en.txt_organization_last_owner_warning = 'This organization must keep at least one confirmed owner.';
messages.en.txt_organization_member_permission_hint = 'Save after changing role or collection permissions.';
messages.en.txt_organization_member_saved = 'Member permissions updated';
messages.en.txt_save_member_failed = 'Failed to update member permissions';
messages.en.txt_save_permissions = 'Save Permissions';
messages.en.txt_access_scope = 'Access scope';
messages.en.txt_access_all_collections = 'Access all collections';
messages.en.txt_full_collection_access = 'This member can access every collection in the organization.';
messages.en.txt_selected_collections_count = '{count} collection(s) selected';
messages.en.txt_can_manage = 'Manage';
messages.en.txt_full_access = 'Full access';
messages.en.txt_no_members_yet = 'No members are available for this organization yet.';
messages.en.txt_you = 'You';
messages.en.txt_status_revoked = 'Revoked';
messages.en.txt_status_invited = 'Invited';
messages.en.txt_status_accepted = 'Accepted';
...
zhCNOverrides.nav_organizations = '组织';
zhCNOverrides.txt_create_organization = '创建组织';
zhCNOverrides.txt_create_organization_failed = '创建组织失败';
zhCNOverrides.txt_create_collection = '创建集合';
zhCNOverrides.txt_create_collection_failed = '创建集合失败';
zhCNOverrides.txt_organization_name = '组织名称';
zhCNOverrides.txt_organization_name_placeholder = '团队密码库名称';
zhCNOverrides.txt_organization_name_required = '组织名称不能为空';
zhCNOverrides.txt_billing_email_optional = '账单邮箱';
zhCNOverrides.txt_default_collection = '默认集合';
zhCNOverrides.txt_default_collection_placeholder = '默认';
zhCNOverrides.txt_default_collection_help = '留空时会自动使用默认集合名称。';
zhCNOverrides.txt_your_organizations = '我的组织';
zhCNOverrides.txt_no_organizations_yet = '还没有组织，可以先在这里创建第一个。';
zhCNOverrides.txt_select_an_organization = '选择一个组织';
zhCNOverrides.txt_select_an_organization_help = '先从左侧选择一个组织，再管理它的集合和成员。';
zhCNOverrides.txt_organization_page_intro = '在一个页面里创建共享密码库、查看集合，并调整成员权限。';
zhCNOverrides.txt_organization_overview_help = '这里显示共享密码库的概览和权限统计。';
zhCNOverrides.txt_organization_created = '组织已创建';
zhCNOverrides.txt_collections = '集合';
zhCNOverrides.txt_members = '成员';
zhCNOverrides.txt_confirmed = '已确认';
zhCNOverrides.txt_collection_name_required = '集合名称不能为空';
zhCNOverrides.txt_collection_name_placeholder = '集合名称';
zhCNOverrides.txt_organization_collection_created = '集合已创建';
zhCNOverrides.txt_organization_collections_help = '集合决定了组织成员可以看到哪些共享项目，以及是否可以编辑。';
zhCNOverrides.txt_organization_collections_read_only = '你现在可以查看集合，但只有具备完整权限的组织管理员或管理者才能创建新集合。';
zhCNOverrides.txt_no_collections_yet = '这个组织还没有集合，可以先创建一个开始分组共享项目。';
zhCNOverrides.txt_organization_members_help = '在这里调整成员角色、集合可见范围和编辑权限。';
zhCNOverrides.txt_organization_member_invite_note = '成员邀请和接受邀请的页面流程还没接进来；当前页面先负责管理现有成员及其集合权限。';
zhCNOverrides.txt_organization_members_read_only = '你当前在这个组织里只有只读查看权限。';
zhCNOverrides.txt_organization_owner_required_for_admin_roles = '只有 Owner 才能授予或撤销 Owner / Admin 角色。';
zhCNOverrides.txt_organization_last_owner_warning = '组织里至少要保留一个已确认的 Owner。';
zhCNOverrides.txt_organization_member_permission_hint = '修改角色或集合权限后，记得点击保存。';
zhCNOverrides.txt_organization_member_saved = '成员权限已更新';
zhCNOverrides.txt_save_member_failed = '更新成员权限失败';
zhCNOverrides.txt_save_permissions = '保存权限';
zhCNOverrides.txt_access_scope = '访问范围';
zhCNOverrides.txt_access_all_collections = '访问全部集合';
zhCNOverrides.txt_full_collection_access = '该成员可以访问这个组织下的全部集合。';
zhCNOverrides.txt_selected_collections_count = '已选择 {count} 个集合';
zhCNOverrides.txt_can_manage = '可管理';
zhCNOverrides.txt_full_access = '完整权限';
zhCNOverrides.txt_no_members_yet = '这个组织暂时还没有可显示的成员。';
zhCNOverrides.txt_you = '你';
zhCNOverrides.txt_status_revoked = '已撤销';
zhCNOverrides.txt_status_invited = '已邀请';
zhCNOverrides.txt_status_accepted = '已接受';
